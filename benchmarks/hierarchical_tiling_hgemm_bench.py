...
gpu_ops = {
    "hierarchical_tiling_hgemm": hgemm_ext.hierarchical_tiling_hgemm,
    "cuBLAS": torch.matmul,
}
...
out_dir = "./results"
out_name = "hierarchical_tiling_hgemm_benchmark.png"
title = "Hierarchical Tiling HGEMM Performance Comparison"
